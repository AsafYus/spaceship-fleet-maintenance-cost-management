...
public:
    Researchship(std::string name, int commission_year, float maximal_speed, int cargo_capacity, int number_of_research_labs);

    // Sets the number of research labs of researchship.
    void set_number_of_research_labs(int _number_of_research_labs);
